...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,400&family=Playfair+Display:ital,wght@0,500;0,600;0,700;0,800;1,400&display=swap"
        rel="stylesheet">
...
<body class="font-sans antialiased min-h-screen flex flex-col selection:bg-brand-200 selection:text-brand-900">
    ...
    <div class="bg-brand-950 text-brand-100 text-xs py-2.5 px-4 border-b border-brand-900">
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            <div class="flex items-center gap-2">
                ...
                <span class="font-medium">Kedai Buka Hari Ini: <strong class="text-white">08.00 - 22.00
                        WIB</strong></span>
            </div>
    ...
    <header class="sticky top-0 z-40 glass-nav border-b border-brand-200/80 transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            ...
            <a href="#hero" class="flex items-center gap-3.5 group">
                <div
                    class="w-11 h-11 rounded-2xl bg-gradient-to-br from-brand-900 to-brand-800 text-brand-50 flex items-center justify-center font-serif font-bold text-2xl shadow-md group-hover:scale-105 transition-transform duration-300 border border-brand-700">
                    P
                </div>
                <div>
            ...
            <nav class="hidden md:flex items-center gap-8 text-sm font-semibold text-brand-800">
                <a href="#menu" class="hover:text-amber-700 transition-colors py-1 relative group">
                    Daftar Menu
                    <span
                        class="absolute bottom-0 left-0 w-0 h-0.5 bg-amber-700 transition-all duration-300 group-hover:w-full"></span>
                </a>
            ...
            <div class="flex items-center gap-3">
                <button onclick="toggleCart()" aria-label="Buka Keranjang Pesanan"
                    ...
                    <span id="cart-badge"
                        class="bg-amber-600 text-white text-xs font-extrabold px-2.5 py-0.5 rounded-full min-w-[20px] text-center shadow-sm">0</span>
                </button>
            </div>
        </div>
    </header>
    ...
    <main class="flex-1">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                    ...
                    <div class="lg:col-span-7 space-y-6">
                        <div
                            class="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-brand-100/80 border border-brand-200 text-brand-800 text-xs font-semibold tracking-wide">
                            <span class="w-2 h-2 rounded-full bg-amber-600"></span>
                            Kedai Kopi & Dapur Ramah Harian
                        </div>

                        <h1
                            class="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-brand-950 leading-[1.12]">
                            Ruang teduh untuk kopi pagi & santapan hangat.
                        </h1>

                        <p class="text-base sm:text-lg text-brand-700 max-w-2xl leading-relaxed">
                            Diseduh dari biji kopi pilihan tanah nusantara, dipadu racikan menu dapur yang jujur dan
                            nyaman. Tempat pas untuk bekerja, berdiskusi, atau sekadar rehat sejenak.
                        </p>

                        <div class="flex flex-wrap items-center gap-4 pt-3">
                            <a href="#menu"
                                class="px-7 py-4 rounded-2xl bg-brand-900 text-white font-bold text-sm hover:bg-brand-800 transition-all shadow-lg shadow-brand-900/15 inline-flex items-center gap-2.5 active:scale-95">
                            ...
                            <a href="#kontak"
                                class="px-7 py-4 rounded-2xl bg-white border border-brand-300/80 text-brand-900 font-bold text-sm hover:bg-brand-100/60 transition-all inline-flex items-center gap-2 shadow-sm">
                    ...
                    <div class="lg:col-span-5">
                        <div
                            class="bg-white p-7 sm:p-8 rounded-3xl border border-brand-200/90 shadow-xl shadow-brand-950/5 relative space-y-6">
                            <div class="flex items-center justify-between pb-4 border-b border-brand-100">
                                <div>
                                    <span
                                        class="text-[11px] font-bold text-brand-500 uppercase tracking-widest block">Rekomendasi
                                        Hari Ini</span>
                                    <h2 class="font-serif font-bold text-xl text-brand-950">Favorit Pengunjung</h2>
                                </div>
                                <span
                                    class="bg-amber-100 text-amber-900 text-xs px-3 py-1 rounded-xl font-bold border border-amber-200/80">
                                    Top Seller
                                </span>
                            </div>
                            ...
                            <!-- Showcase Item 1 -->
                            <div
                                class="group flex items-center gap-4 p-3.5 rounded-2xl bg-brand-50/60 border border-brand-100/80 hover:bg-brand-50 transition-colors">
                                <img src="https://images.unsplash.com/photo-1541167760496-1628856ab772?auto=format&fit=crop&w=160&q=80"
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-brand-600 mt-0.5 line-clamp-1">Espresso double shot, susu
                                        segar, gula aren Sukabumi.</p>
                                    <button onclick="addToCart('Es Kopi Perkoci Aren', 22000, 'Kopi')"
                                        class="mt-1.5 text-xs font-bold text-amber-700 hover:text-amber-800 inline-flex items-center gap-1 transition-colors">
                            ...
                            <div
                                class="group flex items-center gap-4 p-3.5 rounded-2xl bg-brand-50/60 border border-brand-100/80 hover:bg-brand-50 transition-colors">
                                <img src="https://images.unsplash.com/photo-1603133872878-684f208fb84b?auto=format&fit=crop&w=160&q=80"
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-brand-600 mt-0.5 line-clamp-1">Bumbu gurih kedai, suwiran
                                        ayam, telur mata sapi & kerupuk.</p>
                                    <button onclick="addToCart('Nasi Goreng Spesial Perkoci', 32000, 'Makanan')"
                                        class="mt-1.5 text-xs font-bold text-amber-700 hover:text-amber-800 inline-flex items-center gap-1 transition-colors">
                                        <span>+ Tambah Pesanan</span>
                                    </button>
                                </div>
                            ...
                            <!-- Order Info Banner -->
                            <div
                                class="p-3.5 bg-stone-50 rounded-2xl border border-stone-200/80 text-xs text-stone-600 flex items-center gap-3">
                                <svg class="w-5 h-5 text-amber-700 shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span class="leading-relaxed">Pesan via web tanpa antre. Pilih meja untuk makan di
                                    tempat atau bungkus untuk dibawa pulang.</span>
                            </div>
                        </div>
                    </div>
        ...
        <section id="menu" class="py-16 lg:py-24 bg-white border-b border-brand-200/60">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
                    <div>
                        <span class="text-xs font-bold uppercase tracking-widest text-brand-600 block mb-1">Daftar
                            Hidangan</span>
                    ...
                    <div class="w-full md:w-80">
                        <div class="relative">
                            ...
                            <svg class="w-5 h-5 text-brand-400 absolute left-3.5 top-3.5" fill="none"
                ...
                <!-- Category Tabs -->
                <div
                    class="flex items-center gap-2.5 overflow-x-auto pb-4 mb-10 border-b border-brand-100 scrollbar-none">
                    <button onclick="setCategory('semua')"
                        class="category-btn active px-5 py-2.5 rounded-2xl text-xs sm:text-sm font-bold transition-all bg-brand-900 text-white shrink-0 shadow-sm">
                        Semua Menu
                    </button>
                    <button onclick="setCategory('kopi')"
                        class="category-btn px-5 py-2.5 rounded-2xl text-xs sm:text-sm font-bold transition-all bg-brand-100/70 text-brand-800 hover:bg-brand-200/60 shrink-0">
                        ☕ Kopi (Coffee)
                    </button>
                    <button onclick="setCategory('non-kopi')"
                        class="category-btn px-5 py-2.5 rounded-2xl text-xs sm:text-sm font-bold transition-all bg-brand-100/70 text-brand-800 hover:bg-brand-200/60 shrink-0">
                        🍵 Non-Kopi & Teh
                    </button>
                    <button onclick="setCategory('makanan')"
                        class="category-btn px-5 py-2.5 rounded-2xl text-xs sm:text-sm font-bold transition-all bg-brand-100/70 text-brand-800 hover:bg-brand-200/60 shrink-0">
                        🍛 Makanan Utama
                    </button>
                    <button onclick="setCategory('camilan')"
                        class="category-btn px-5 py-2.5 rounded-2xl text-xs sm:text-sm font-bold transition-all bg-brand-100/70 text-brand-800 hover:bg-brand-200/60 shrink-0">
                        🥐 Camilan & Pastry
                    </button>
                </div>
                ...
                <div id="menu-grid" class="grid sm:grid-cols-2 lg:grid-cols-3 gap-7">
                    ...
                    <div class="menu-card bg-brand-50/40 hover:bg-white border border-brand-200/80 rounded-3xl p-5 flex flex-col justify-between transition-all duration-300 hover:shadow-xl hover:shadow-brand-950/5 hover:-translate-y-1 group"
                        data-category="kopi" data-name="es kopi perkoci aren">
                        <div>
                            <div
                                class="relative overflow-hidden rounded-2xl mb-4 aspect-[4/3] border border-brand-200/60 bg-brand-100">
                                <img src="https://images.unsplash.com/photo-1541167760496-1628856ab772?auto=format&fit=crop&w=600&q=80"
                                    alt="Es Kopi Perkoci Aren"
                                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                                <span
                                    class="absolute top-3 right-3 bg-amber-600 text-white text-[10px] font-extrabold px-2.5 py-1 rounded-xl shadow-md uppercase tracking-wider">
                                    Signature
                                </span>
                            </div>
                            <h3
                                class="font-bold text-brand-950 text-base group-hover:text-amber-700 transition-colors">
                                Es Kopi Perkoci Aren</h3>
                        ...
                        <div class="mt-5 pt-4 border-t border-brand-100 flex items-center justify-between">
                            ...
                            <button onclick="addToCart('Es Kopi Perkoci Aren', 22000, 'Kopi')"
                                class="px-4 py-2 rounded-xl bg-brand-900 text-white text-xs font-bold hover:bg-brand-800 transition-all shadow-sm active:scale-95 inline-flex items-center gap-1">
                                <span>+ Pesan</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="menu-card bg-brand-50/40 hover:bg-white border border-brand-200/80 rounded-3xl p-5 flex flex-col justify-between transition-all duration-300 hover:shadow-xl hover:shadow-brand-950/5 hover:-translate-y-1 group"
                        data-category="kopi" data-name="manual brew v60 aceh gayo filter">
                        <div>
                            <div
                                class="relative overflow-hidden rounded-2xl mb-4 aspect-[4/3] border border-brand-200/60 bg-brand-100">
                                <img src="https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?auto=format&fit=crop&w=600&q=80"
                                    ...
                                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                                <span
                                    class="absolute top-3 right-3 bg-brand-800 text-white text-[10px] font-extrabold px-2.5 py-1 rounded-xl shadow-md uppercase tracking-wider">
                                    Single Origin
                                </span>
                            </div>
                            <h3
                                class="font-bold text-brand-950 text-base group-hover:text-amber-700 transition-colors">
                                Manual Brew V60 (Gayo)</h3>
                            <p class="text-xs text-brand-600 mt-1.5 leading-relaxed">
                                Arabika Aceh Gayo proses washed. Aroma buah segar, keasaman lembut, dan aftertaste
                                bersih.
                            </p>
                        </div>
                        <div class="mt-5 pt-4 border-t border-brand-100 flex items-center justify-between">
                            <span class="font-extrabold text-brand-950 text-base">Rp 26.000</span>
                            <button onclick="addToCart('Manual Brew V60 (Gayo)', 26000, 'Kopi')"
                                class="px-4 py-2 rounded-xl bg-brand-900 text-white text-xs font-bold hover:bg-brand-800 transition-all shadow-sm active:scale-95 inline-flex items-center gap-1">
                                <span>+ Pesan</span>
                            </button>
                        </div>
                    ...
                    <!-- Item: Americano -->
                    <div class="menu-card bg-brand-50/40 hover:bg-white border border-brand-200/80 rounded-3xl p-5 flex flex-col justify-between transition-all duration-300 hover:shadow-xl hover:shadow-brand-950/5 hover:-translate-y-1 group"
                        data-category="kopi" data-name="americano klasik black coffee">
                        <div>
                            <div
                                class="relative overflow-hidden rounded-2xl mb-4 aspect-[4/3] border border-brand-200/60 bg-brand-100">
                                <img src="https://images.unsplash.com/photo-1517701604599-bb29b565090c?auto=format&fit=crop&w=600&q=80"
                                    alt="Classic Americano"
                                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                            </div>
                            <h3
                                class="font-bold text-brand-950 text-base group-hover:text-amber-700 transition-colors">
                                Classic Americano</h3>
                            <p class="text-xs text-brand-600 mt-1.5 leading-relaxed">
                        ...
                        <div class="mt-5 pt-4 border-t border-brand-100 flex items-center justify-between">
                            ...
                            <button onclick="addToCart('Classic Americano', 18000, 'Kopi')"
                                class="px-4 py-2 rounded-xl bg-brand-900 text-white text-xs font-bold hover:bg-brand-800 transition-all shadow-sm active:scale-95 inline-flex items-center gap-1">
                                <span>+ Pesan</span>
                            </button>
                        </div>
                    ...
                    <div class="menu-card bg-brand-50/40 hover:bg-white border border-brand-200/80 rounded-3xl p-5 flex flex-col justify-between transition-all duration-300 hover:shadow-xl hover:shadow-brand-950/5 hover:-translate-y-1 group"
                        data-category="non-kopi" data-name="uji matcha latte hijau">
                        <div>
                            <div
                                class="relative overflow-hidden rounded-2xl mb-4 aspect-[4/3] border border-brand-200/60 bg-brand-100">
                                <img src="https://images.unsplash.com/photo-1536256263959-770b48d82b0a?auto=format&fit=crop&w=600&q=80"
                                    alt="Pure Uji Matcha Latte"
                                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                                <span
                                    class="absolute top-3 right-3 bg-emerald-600 text-white text-[10px] font-extrabold px-2.5 py-1 rounded-xl shadow-md uppercase tracking-wider">
                                    Favorit
                                </span>
                            </div>
                            <h3
                                class="font-bold text-brand-950 text-base group-hover:text-amber-700 transition-colors">
                                Pure Uji Matcha Latte</h3>
                            <p class="text-xs text-brand-600 mt-1.5 leading-relaxed">
                        ...
                        <div class="mt-5 pt-4 border-t border-brand-100 flex items-center justify-between">
                            ...
                            <button onclick="addToCart('Pure Uji Matcha Latte', 25000, 'Non-Kopi')"
                                class="px-4 py-2 rounded-xl bg-brand-900 text-white text-xs font-bold hover:bg-brand-800 transition-all shadow-sm active:scale-95 inline-flex items-center gap-1">
                                <span>+ Pesan</span>
                            </button>
                        </div>
                    ...
                    <div class="menu-card bg-brand-50/40 hover:bg-white border border-brand-200/80 rounded-3xl p-5 flex flex-col justify-between transition-all duration-300 hover:shadow-xl hover:shadow-brand-950/5 hover:-translate-y-1 group"
                        data-category="non-kopi" data-name="artisan dark chocolate cokelat">
                        <div>
                            <div
                                class="relative overflow-hidden rounded-2xl mb-4 aspect-[4/3] border border-brand-200/60 bg-brand-100">
                                <img src="https://images.unsplash.com/photo-1542990253-0d0f5be5f0ed?auto=format&fit=crop&w=600&q=80"
                                    alt="Artisan Dark Chocolate"
                                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                            </div>
                            <h3
                                class="font-bold text-brand-950 text-base group-hover:text-amber-700 transition-colors">
                                Artisan Dark Chocolate</h3>
                            <p class="text-xs text-brand-600 mt-1.5 leading-relaxed">
                                Cokelat pekat 65% khas Sulawesi dilelehkan dengan susu hangat. Rasa kaya tanpa terlalu
                                manis.
                            </p>
                        </div>
                        <div class="mt-5 pt-4 border-t border-brand-100 flex items-center justify-between">
                            <span class="font-extrabold text-brand-950 text-base">Rp 24.000</span>
                            <button onclick="addToCart('Artisan Dark Chocolate', 24000, 'Non-Kopi')"
                                class="px-4 py-2 rounded-xl bg-brand-900 text-white text-xs font-bold hover:bg-brand-800 transition-all shadow-sm active:scale-95 inline-flex items-center gap-1">
                                <span>+ Pesan</span>
                            </button>
                        </div>
                    ...
                    <div class="menu-card bg-brand-50/40 hover:bg-white border border-brand-200/80 rounded-3xl p-5 flex flex-col justify-between transition-all duration-300 hover:shadow-xl hover:shadow-brand-950/5 hover:-translate-y-1 group"
                        data-category="makanan" data-name="nasi goreng spesial perkoci makanan">
                        <div>
                            <div
                                class="relative overflow-hidden rounded-2xl mb-4 aspect-[4/3] border border-brand-200/60 bg-brand-100">
                                <img src="https://images.unsplash.com/photo-1603133872878-684f208fb84b?auto=format&fit=crop&w=600&q=80"
                            ...
                            <h3
                                class="font-bold text-brand-950 text-base group-hover:text-amber-700 transition-colors">
                                Nasi Goreng Spesial Perkoci</h3>
                            <p class="text-xs text-brand-600 mt-1.5 leading-relaxed">
                    ...
                    <div class="menu-card bg-brand-50/40 hover:bg-white border border-brand-200/80 rounded-3xl p-5 flex flex-col justify-between transition-all duration-300 hover:shadow-xl hover:shadow-brand-950/5 hover:-translate-y-1 group"
                        data-category="makanan" data-name="spaghetti aglio olio smoked beef pasta">
                        <div>
                            <div
                                class="relative overflow-hidden rounded-2xl mb-4 aspect-[4/3] border border-brand-200/60 bg-brand-100">
                                <img src="https://images.unsplash.com/photo-1621996346565-e3d5d6281288?auto=format&fit=crop&w=600&q=80"
                                    alt="Spaghetti Aglio Olio Smoked Beef"
                                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                            </div>
                            <h3
                                class="font-bold text-brand-950 text-base group-hover:text-amber-700 transition-colors">
                                Spaghetti Aglio Olio Smoked Beef</h3>
                            <p class="text-xs text-brand-600 mt-1.5 leading-relaxed">
                                Pasta al dente ditumis minyak zaitun, bawang putih harum, cabai kering & daging asap
                                melimpah.
                            </p>
                        </div>
                        <div class="mt-5 pt-4 border-t border-brand-100 flex items-center justify-between">
                            <span class="font-extrabold text-brand-950 text-base">Rp 34.000</span>
                            <button onclick="addToCart('Spaghetti Aglio Olio Smoked Beef', 34000, 'Makanan')"
                                class="px-4 py-2 rounded-xl bg-brand-900 text-white text-xs font-bold hover:bg-brand-800 transition-all shadow-sm active:scale-95 inline-flex items-center gap-1">
                                <span>+ Pesan</span>
                            </button>
                        </div>
                    ...
                    <div class="menu-card bg-brand-50/40 hover:bg-white border border-brand-200/80 rounded-3xl p-5 flex flex-col justify-between transition-all duration-300 hover:shadow-xl hover:shadow-brand-950/5 hover:-translate-y-1 group"
                        data-category="camilan" data-name="croissant butter pastry camilan">
                        <div>
                            <div
                                class="relative overflow-hidden rounded-2xl mb-4 aspect-[4/3] border border-brand-200/60 bg-brand-100">
                                <img src="https://images.unsplash.com/photo-1555507036-ab1f4038808a?auto=format&fit=crop&w=600&q=80"
                        ...
                        <div class="mt-5 pt-4 border-t border-brand-100 flex items-center justify-between">
                            ...
                            <button onclick="addToCart('Warm Butter Croissant', 20000, 'Camilan')"
                                class="px-4 py-2 rounded-xl bg-brand-900 text-white text-xs font-bold hover:bg-brand-800 transition-all shadow-sm active:scale-95 inline-flex items-center gap-1">
                                <span>+ Pesan</span>
                            </button>
                        </div>
                    ...
                    <div class="menu-card bg-brand-50/40 hover:bg-white border border-brand-200/80 rounded-3xl p-5 flex flex-col justify-between transition-all duration-300 hover:shadow-xl hover:shadow-brand-950/5 hover:-translate-y-1 group"
                        data-category="camilan" data-name="pisang goreng madu wijen snack">
                        <div>
                            <div
                                class="relative overflow-hidden rounded-2xl mb-4 aspect-[4/3] border border-brand-200/60 bg-brand-100">
                        ...
                        <div class="mt-5 pt-4 border-t border-brand-100 flex items-center justify-between">
                            <span class="font-extrabold text-brand-950 text-base">Rp 18.000</span>
                            <button onclick="addToCart('Pisang Goreng Madu Wijen', 18000, 'Camilan')"
                                class="px-4 py-2 rounded-xl bg-brand-900 text-white text-xs font-bold hover:bg-brand-800 transition-all shadow-sm active:scale-95 inline-flex items-center gap-1">
                                <span>+ Pesan</span>
                            </button>
                        </div>
                ...
                <!-- Empty State -->
                <div id="no-menu"
                    class="hidden text-center py-16 text-brand-600 bg-brand-50/50 rounded-3xl border border-brand-200/60 mt-6">
                    <span class="text-3xl block mb-2">🔍</span>
                    <p class="font-serif text-lg font-bold text-brand-950">Menu tidak ditemukan</p>
                    <p class="text-xs text-brand-600 mt-1">Coba gunakan kata kunci lain seperti "kopi", "nasi", atau
                        "croissant".</p>
                </div>
        ...
        <section id="tentang" class="py-16 lg:py-24 bg-brand-100/40 border-b border-brand-200/60">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    <div class="space-y-6">
                        <span class="text-xs font-bold uppercase tracking-widest text-brand-600 block">Nilai Kedai
                            Kami</span>
                        ...
                        <p class="text-brand-700 leading-relaxed text-sm sm:text-base">
                            Perkoci hadir dari kerinduan akan tempat nongkrong yang tidak terburu-buru. Kami meracik
                            setiap cangkir kopi dan piring sajian dengan bahan-bahan pilihan tanah air yang segar setiap
                            hari.
                        </p>
                        <p class="text-brand-700 leading-relaxed text-sm sm:text-base">
                            Tanpa pemanis buatan berlebih atau proses yang dipaksakan. Hanya cita rasa jujur yang pas
                            menemani waktu luang maupun kesibukan Anda.
                        </p>
                        ...
                        <div class="grid grid-cols-2 gap-4 pt-4 border-t border-brand-200/80">
                            <div class="p-4 rounded-2xl bg-white border border-brand-200/70 shadow-sm">
                                ...
                                <span class="text-xs text-brand-600 mt-0.5 block">Racikan konsisten harga
                                    terjangkau</span>
                            </div>
                            <div class="p-4 rounded-2xl bg-white border border-brand-200/70 shadow-sm">
                    ...
                    <!-- Facilities Grid -->
                    <div id="fasilitas"
                        class="bg-white p-8 sm:p-10 rounded-3xl border border-brand-200/80 shadow-lg shadow-brand-950/5 space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="p-4 rounded-2xl bg-brand-50/70 border border-brand-100">
                                ...
                                <p class="text-xs text-brand-600 mt-1">Tersedia colokan di hampir setiap sudut meja.
                                </p>
                            </div>
                            <div class="p-4 rounded-2xl bg-brand-50/70 border border-brand-100">
                                <span class="text-2xl block mb-2">📶</span>
                                <h4 class="font-bold text-brand-950 text-sm">Wi-Fi 100 Mbps</h4>
                                <p class="text-xs text-brand-600 mt-1">Koneksi stabil untuk kerja, streaming & zoom.
                                </p>
                            </div>
                            <div class="p-4 rounded-2xl bg-brand-50/70 border border-brand-100">
                                <span class="text-2xl block mb-2">🌿</span>
                                <h4 class="font-bold text-brand-950 text-sm">Area Outdoor</h4>
                                <p class="text-xs text-brand-600 mt-1">Area outdoor teduh untuk merokok & bersantai.
                                </p>
                            </div>
                            <div class="p-4 rounded-2xl bg-brand-50/70 border border-brand-100">
                                <span class="text-2xl block mb-2">🕌</span>
        ...
        <section id="kontak" class="py-16 lg:py-24 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div
                    class="bg-gradient-to-br from-brand-950 via-brand-900 to-brand-850 text-brand-100 rounded-3xl p-8 sm:p-14 overflow-hidden relative shadow-2xl border border-brand-800">
                    <div class="grid lg:grid-cols-12 gap-8 items-center">
                        <div class="lg:col-span-7 space-y-5">
                            <span class="text-amber-400 text-xs font-extrabold uppercase tracking-widest block">Lokasi
                                & Operasional</span>
                            ...
                            <div class="space-y-3 pt-3 text-xs sm:text-sm font-medium">
                                <div class="flex items-center gap-3">
                                    <span
                                        class="w-7 h-7 rounded-xl bg-brand-800 text-amber-400 flex items-center justify-center shrink-0">📍</span>
                        ...
                        <div
                            class="lg:col-span-5 bg-white/5 backdrop-blur-md p-6 rounded-3xl border border-white/10 text-center space-y-4">
                            <h3 class="font-serif font-bold text-xl text-white">Reservasi Meja / Event</h3>
                            <p class="text-xs text-brand-300 leading-relaxed">
                                Untuk reservasi kelompok di atas 6 orang atau diskusi komunitas, hubungi kasir kami
                                langsung.
                            </p>
                            <a href="https://wa.me/6281234567890?text=Halo%20Perkoci%20Eatery,%20saya%20ingin%20tanya%20reservasi%20meja"
                                target="_blank"
    ...
    <div id="cart-drawer-backdrop" onclick="toggleCart()"
        class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden transition-opacity duration-300"></div>

    <aside id="cart-drawer"
        class="fixed top-0 right-0 h-full w-full max-w-md bg-white z-50 shadow-2xl flex flex-col translate-x-full transition-transform duration-300 ease-in-out border-l border-brand-200">
        <!-- Header -->
        <div class="p-6 bg-brand-50 border-b border-brand-200/80 flex items-center justify-between">
            ...
            <button onclick="toggleCart()" aria-label="Tutup Keranjang"
                class="p-2 rounded-xl text-brand-600 hover:bg-brand-200/60 transition">
        ...
        <div class="p-6 bg-brand-50/80 border-t border-brand-200/80 space-y-4">
            <div>
                ...
                <div class="grid grid-cols-2 gap-2">
                    <select id="order-type" onchange="toggleTableInput()"
                        class="text-xs font-semibold bg-white border border-brand-300 rounded-xl p-2.5 focus:ring-2 focus:ring-amber-600 focus:outline-none">
            ...
            <div class="pt-3 border-t border-brand-200/80 space-y-1.5 text-xs text-brand-700">
                ...
                <div
                    class="flex justify-between text-base font-extrabold text-brand-950 pt-2 border-t border-brand-200/80">
    ...
    <div id="receipt-modal"
        ...
        <div
            class="bg-white max-w-sm w-full rounded-3xl border border-brand-200 p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in duration-200">
            <div class="text-center space-y-1">
                <div
                    class="w-12 h-12 rounded-full bg-emerald-100 text-emerald-700 mx-auto flex items-center justify-center text-2xl font-bold mb-2">
                    ✓
                </div>
            ...
            <button onclick="closeReceipt()"
                class="w-full py-3.5 rounded-2xl bg-brand-900 text-white text-xs font-bold hover:bg-brand-950 transition-all shadow-md">
                Tutup & Pesan Baru
            </button>
        </div>
    </div>
    ...
    <script>
        ...
        function processOrder() {
            ...
            document.getElementById('receipt-date').textContent = new Date().toLocaleTimeString('id-ID', {
                hour: '2-digit',
                minute: '2-digit'
            });
